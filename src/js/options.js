...
var DEFAULT_MAX_HISTORY_LENGTH = 5;
...
function validateMaxResults() {
  ...
  if (inputVal.match(/^\d+$/) && Number.isInteger(parseInt(inputVal))) {
    ...
    markStatus(
      "'" + inputVal + "' is not an integer. Please try another value.",
      2000
    );
    document.getElementById("maxResults").style.backgroundColor = ERROR_COLOR;
  }
...
function loadOptions() {
  chrome.storage.local.get(
    ...
    function (result) {
      ...
      document.getElementById("exampleHighlighted").style.backgroundColor =
        result.highlightColor;
      document.getElementById("selectedColor").value = result.selectedColor;
      document.getElementById("exampleSelected").style.backgroundColor =
        result.selectedColor;
      document.getElementById("textColor").value = result.textColor;
      document.getElementById("exampleHighlighted").style.color =
        result.textColor;
      ...
      document.getElementById("maxHistoryLength").value =
        result.maxHistoryLength;
      var searchEngineDropDown = document.getElementById("searchEngine");
      for (var i = 0; i < searchEngineDropDown.options.length; i++) {
        if (searchEngineDropDown.options[i].value == searchEngine) {
          searchEngineDropDown.options[i].selected = true;
          break;
        }
      }
    }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    ...
    .addEventListener("change", function () {
      document.getElementById(
        "exampleHighlighted"
      ).style.backgroundColor = document.getElementById("highlightColor").value;
      saveOptions();
    });
  ...
  document
    ...
    .addEventListener("change", function () {
      document.getElementById(
        "exampleSelected"
      ).style.backgroundColor = document.getElementById("selectedColor").value;
      saveOptions();
    });
  ...
  document.getElementById("textColor").addEventListener("change", function () {
    document.getElementById(
      "exampleHighlighted"
    ).style.color = document.getElementById("textColor").value;
    document.getElementById(
      "exampleSelected"
    ).style.color = document.getElementById("textColor").value;
    saveOptions();
  ...
  document
    .getElementById("instantResults")
    .addEventListener("change", function () {
      saveOptions();
    });

  document
    .getElementById("maxHistoryLength")
    .addEventListener("change", function () {
      saveOptions();
    });
